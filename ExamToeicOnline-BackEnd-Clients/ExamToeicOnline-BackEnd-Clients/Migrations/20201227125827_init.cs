    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("38573b8d-bc34-420b-afcc-a436a496d482"), new DateTime(1999, 5, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "nhan@gmail.com", "Nguyễn Thanh Nhân", null, "12345678" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Birthday", "Email", "Fullname", "Image", "PhoneNumber" },
                values: new object[] { new Guid("16c0afee-f96d-4ae1-9b18-3a9397854831"), new DateTime(1999, 11, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "ngan@gmail.com", "Đỗ Thị Thanh Ngân", null, "98765432" });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Id", "CreateAt", "Password", "UserId", "Username", "isActive", "isAdmin" },
                values: new object[] { 1, new DateTime(2020, 12, 27, 19, 58, 26, 851, DateTimeKind.Local).AddTicks(4907), "$2a$11$UDXCKUOZcMFV0rvYitDeUOaUQwIv0bXXuocO2sWsGsjHXPJORkGNi", new Guid("38573b8d-bc34-420b-afcc-a436a496d482"), "ngan", true, false });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Id", "CreateAt", "Password", "UserId", "Username", "isActive", "isAdmin" },
                values: new object[] { 2, new DateTime(2020, 12, 27, 19, 58, 26, 851, DateTimeKind.Local).AddTicks(4907), "$2a$11$bma17yvGMddyU/SG0MEsR.Md0yFsxAeggkIkxr6Bi0.tEIyL7DB7S", new Guid("16c0afee-f96d-4ae1-9b18-3a9397854831"), "nhan", true, false });
