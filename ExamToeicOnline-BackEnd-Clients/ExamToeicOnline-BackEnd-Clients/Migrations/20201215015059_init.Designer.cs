            ...
            modelBuilder.Entity("ExamToeicOnline_FrontEnd_Clients.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2020, 12, 15, 8, 50, 58, 359, DateTimeKind.Local).AddTicks(4381),
                            Password = "$2a$11$2q2cXa0/mKF2khQMl6M8yetCj9gu0vfYQpwdWLRo9gpl3v.2H6Fm.",
                            UserId = new Guid("cb3f78df-8a0e-42ce-ba99-374557ab0bab"),
                            Username = "ngan",
                            isActive = true,
                            isAdmin = false
                        },
                        new
                        {
                            Id = 2,
                            CreateAt = new DateTime(2020, 12, 15, 8, 50, 58, 359, DateTimeKind.Local).AddTicks(4381),
                            Password = "$2a$11$GIyVXpJasf30vG7btA7sUu90STj3vKyklOPkLvkpSphDtJc9KPpam",
                            UserId = new Guid("e184ea9d-8d9b-4785-8b20-863f41c07911"),
                            Username = "nhan",
                            isActive = true,
                            isAdmin = false
                        });
            ...
            modelBuilder.Entity("ExamToeicOnline_FrontEnd_Clients.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cb3f78df-8a0e-42ce-ba99-374557ab0bab"),
                        ...
                        new
                        {
                            Id = new Guid("e184ea9d-8d9b-4785-8b20-863f41c07911"),
