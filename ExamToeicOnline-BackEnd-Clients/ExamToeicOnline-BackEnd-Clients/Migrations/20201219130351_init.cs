    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("f06cbd00-ab44-4260-99b9-6418a51fbec6"), new DateTime(1999, 5, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "nhan@gmail.com", "Nguyễn Thanh Nhân", null, "12345678" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Birthday", "Email", "Fullname", "Image", "PhoneNumber" },
                values: new object[] { new Guid("4c55aaa4-1ad0-459d-85ce-4e3441759883"), new DateTime(1999, 11, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "ngan@gmail.com", "Đỗ Thị Thanh Ngân", null, "98765432" });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Id", "CreateAt", "Password", "UserId", "Username", "isActive", "isAdmin" },
                values: new object[] { 1, new DateTime(2020, 12, 19, 20, 3, 50, 277, DateTimeKind.Local).AddTicks(7392), "$2a$11$Eo7NvYrXhggqf5Ydv8m1JuO0wiVGWm/OKMCq3JnwBRBOplCo17qKG", new Guid("f06cbd00-ab44-4260-99b9-6418a51fbec6"), "ngan", true, false });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Id", "CreateAt", "Password", "UserId", "Username", "isActive", "isAdmin" },
                values: new object[] { 2, new DateTime(2020, 12, 19, 20, 3, 50, 277, DateTimeKind.Local).AddTicks(7392), "$2a$11$28LFa1rO1BHINxGO1jfyoei.p7dIedayDJgYOe5ibqPPHHmVRIwQS", new Guid("4c55aaa4-1ad0-459d-85ce-4e3441759883"), "nhan", true, false });
