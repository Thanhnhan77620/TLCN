    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("cb3f78df-8a0e-42ce-ba99-374557ab0bab"), new DateTime(1999, 5, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "nhan@gmail.com", "Nguyễn Thanh Nhân", null, "12345678" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Birthday", "Email", "Fullname", "Image", "PhoneNumber" },
                values: new object[] { new Guid("e184ea9d-8d9b-4785-8b20-863f41c07911"), new DateTime(1999, 11, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "ngan@gmail.com", "Đỗ Thị Thanh Ngân", null, "98765432" });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Id", "CreateAt", "Password", "UserId", "Username", "isActive", "isAdmin" },
                values: new object[] { 1, new DateTime(2020, 12, 15, 8, 50, 58, 359, DateTimeKind.Local).AddTicks(4381), "$2a$11$2q2cXa0/mKF2khQMl6M8yetCj9gu0vfYQpwdWLRo9gpl3v.2H6Fm.", new Guid("cb3f78df-8a0e-42ce-ba99-374557ab0bab"), "ngan", true, false });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Id", "CreateAt", "Password", "UserId", "Username", "isActive", "isAdmin" },
                values: new object[] { 2, new DateTime(2020, 12, 15, 8, 50, 58, 359, DateTimeKind.Local).AddTicks(4381), "$2a$11$GIyVXpJasf30vG7btA7sUu90STj3vKyklOPkLvkpSphDtJc9KPpam", new Guid("e184ea9d-8d9b-4785-8b20-863f41c07911"), "nhan", true, false });
